...
void ipmb_init ( void )
{
    ...
    xTaskCreate( IPMB_TXTask, (const char*)"IPMB_TX", 200, ( void * ) NULL, tskIPMB_TX_PRIORITY, ( TaskHandle_t * ) NULL );
    xTaskCreate( IPMB_RXTask, (const char*)"IPMB_RX", 200, ( void * ) NULL, tskIPMB_RX_PRIORITY, ( TaskHandle_t * ) NULL );
}
